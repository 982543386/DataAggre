...
import org.ku8eye.mapping.YamlRegistryMapper;
...
public class YamlService {
	@Autowired
	private YamlRegistryMapper YamlDao;
	...
	public int insertContent(String yamlContent) {
		YamlRegistry yamlRegistry = new YamlRegistry();
		/*yamlRegistry.setId((byte) 1);*/
		yamlRegistry.setContent(yamlContent);
		
		return YamlDao.insert(yamlRegistry);
	}
