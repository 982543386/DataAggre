...
import org.ku8eye.domain.K8OrderMiddleware;
import org.apache.ibatis.annotations.Delete;
import org.apache.ibatis.annotations.Update;

public interface K8OrderMiddlewareMapper {

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table k8order_middleware
	 * @mbg.generated  Mon Aug 07 15:16:21 CST 2017
	 */
	@Delete({ "delete from k8order_middleware", "where id = #{id,jdbcType=INTEGER}" })
	 ...
	 * @mbg.generated  Mon Aug 07 15:16:21 CST 2017
	 */
	@Insert({ "insert into k8order_middleware (id, zone, ", "type, version, cluster_count, ",
			"resource_type, storage_type, ", "disk_space, database_name, ", "username, password, ",
			"url, port, remark, ", "security, additional_service, ", "k8order_id, user_id, ", "remark_admin)",
			...
			"#{k8orderId,jdbcType=VARCHAR}, #{userId,jdbcType=VARCHAR}, ", "#{remarkAdmin,jdbcType=VARCHAR})" })
	int insert(K8OrderMiddleware record);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table k8order_middleware
	 * @mbg.generated  Mon Aug 07 15:16:21 CST 2017
	 */
	@Select({ "select", "id, zone, type, version, cluster_count, resource_type, storage_type, disk_space, ",
			"database_name, username, password, url, port, remark, security, additional_service, ",
			"k8order_id, user_id, remark_admin", "from k8order_middleware", "where id = #{id,jdbcType=INTEGER}" })
	...
	K8OrderMiddleware selectByPrimaryKey(Integer id);
	
	
	@Select({ "select", "id, zone, type, version, cluster_count, resource_type, storage_type, disk_space, ",
		"database_name, username, password, url, port, remark, security, additional_service, ",
		"k8order_id, user_id, remark_admin", "from k8order_middleware", "where k8order_id = #{orderId,jdbcType=INTEGER}" })
@Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true),
		@Result(column = "zone", property = "zone", jdbcType = JdbcType.INTEGER),
		@Result(column = "type", property = "type", jdbcType = JdbcType.INTEGER),
		@Result(column = "version", property = "version", jdbcType = JdbcType.VARCHAR),
		...
		@Result(column = "user_id", property = "userId", jdbcType = JdbcType.VARCHAR),
		@Result(column = "remark_admin", property = "remarkAdmin", jdbcType = JdbcType.VARCHAR) })
K8OrderMiddleware selectByOrderId(String orderId);
	...
	@Select({ "select", "id, zone, type, version, cluster_count, resource_type, storage_type, disk_space, ",
			"database_name, username, password, url, port, remark, security, additional_service, ",
			"k8order_id, user_id, remark_admin", "from k8order_middleware" })
	@Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true),
			@Result(column = "zone", property = "zone", jdbcType = JdbcType.INTEGER),
			@Result(column = "type", property = "type", jdbcType = JdbcType.INTEGER),
			@Result(column = "version", property = "version", jdbcType = JdbcType.VARCHAR),
			...
			@Result(column = "user_id", property = "userId", jdbcType = JdbcType.VARCHAR),
			@Result(column = "remark_admin", property = "remarkAdmin", jdbcType = JdbcType.VARCHAR) })
	List<K8OrderMiddleware> selectAll();

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table k8order_middleware
	 * @mbg.generated  Mon Aug 07 15:16:21 CST 2017
	 */
	@Update({ "update k8order_middleware", "set zone = #{zone,jdbcType=INTEGER},", "type = #{type,jdbcType=INTEGER},",
			"version = #{version,jdbcType=VARCHAR},", "cluster_count = #{clusterCount,jdbcType=INTEGER},",
			"resource_type = #{resourceType,jdbcType=INTEGER},", "storage_type = #{storageType,jdbcType=INTEGER},",
			"disk_space = #{diskSpace,jdbcType=INTEGER},", "database_name = #{databaseName,jdbcType=VARCHAR},",
			"username = #{username,jdbcType=VARCHAR},", "password = #{password,jdbcType=VARCHAR},",
			"url = #{url,jdbcType=VARCHAR},", "port = #{port,jdbcType=INTEGER},",
			...
			"remark_admin = #{remarkAdmin,jdbcType=VARCHAR}", "where id = #{id,jdbcType=INTEGER}" })
	int updateByPrimaryKey(K8OrderMiddleware record);
	
	 @Update({
	        "update k8order_middleware a,k8order b",
	    ...
	    int updateByK8OrderId(K8OrderMiddleware record);
}